...
| D-0020 | Branch protection configuration options | OPD_006_BRANCH_PROTECTION_CONFIGURATION_OPTIONS_RECORDED / OWNER_DECISION_PENDING / NO_BRANCH_PROTECTION_CHANGE / NO_REQUIRED_CHECKS_CONFIGURATION_CHANGE / NO_RUNTIME_EFFECT / NOT_PRODUCTION_READY | `docs/governance/BRANCH_PROTECTION_CONFIGURATION_OPTIONS.md` |
