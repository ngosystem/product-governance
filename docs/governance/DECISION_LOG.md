...
| D-0024 | OPD-006 GitHub Free for now owner decision | OPD_006_OWNER_DECISION_GITHUB_FREE_FOR_NOW_RECORDED / GITHUB_FREE_CURRENT_PLAN_ACCEPTED_FOR_NOW / SUPERSEDED_IN_PART_BY_D_0025_PRODUCT_GOVERNANCE_DECISION / BACKEND_AND_TENANT_BRANCH_PROTECTION_REMAIN_DEFERRED / NO_PAID_GITHUB_PLAN_CHANGE / NO_RUNTIME_EFFECT / NOT_PRODUCTION_READY | `docs/governance/BRANCH_PROTECTION_CONFIGURATION_OPTIONS.md` |
| D-0025 | Product-governance PR gate and quality check owner decision | OPD_006_PRODUCT_GOVERNANCE_BRANCH_PROTECTION_DECISION_RECORDED / PRODUCT_GOVERNANCE_PR_GATE_SELECTED / PRODUCT_GOVERNANCE_REQUIRED_CHECK_CONTEXT_RECORDED / PRODUCT_GOVERNANCE_ADMIN_ENFORCEMENT_DISABLED_RECORDED / NO_PAID_GITHUB_PLAN_CHANGE / NO_RUNTIME_EFFECT / NOT_PRODUCTION_READY | `docs/governance/BRANCH_PROTECTION_CONFIGURATION_OPTIONS.md`; `docs/governance/GITHUB_BRANCH_PROTECTION_EVIDENCE_2026-07-06.md` |
